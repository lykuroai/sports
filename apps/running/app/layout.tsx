...
export const metadata: Metadata = {
  title: { default: "ランニング｜スポともパーク", template: "%s｜スポともパーク" },
  ...
  return (
    <html lang="ja">
      <body className="min-h-screen">
        <SiteHeader appName="" brand="ランニングとも" portalUrl={SITE_URL} logo={<Image src="/running-logo.svg" alt="ランニングとも" width={72} height={48} priority className="h-12 w-auto" />} accountUrl={accountUrl} currentOrigin={currentOrigin} myPageHref="/mypage" loggedIn={!!user} loginHref={loginHref} actions={<NotificationBell accountUrl={accountUrl} />} />
