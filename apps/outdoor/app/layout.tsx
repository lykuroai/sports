...
export const metadata: Metadata = {
  title: { default: "アウトドア｜スポともパーク", template: "%s｜スポともパーク" },
  ...
  return (
    <html lang="ja">
      <body className="min-h-screen">
        <SiteHeader appName="アウトドア" accountUrl={accountUrl} currentOrigin={currentOrigin} actions={<NotificationBell accountUrl={accountUrl} />} />
