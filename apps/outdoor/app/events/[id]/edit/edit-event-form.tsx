...
export default function EditEventForm({
  ...
  return (
    <div className="mx-auto max-w-xl space-y-4">
      <h1 className="text-2xl font-bold">アウトドアの募集を修正</h1>
      ...
      <form action={formAction} className="card space-y-4 p-6">
        ...
        <div>
          <label className="label" htmlFor="activity_type">アクティビティ種別（任意）</label>
          <input id="activity_type" name="activity_type" className="input" maxLength={120} defaultValue={event.activity_type ?? ""} />
        </div>
        ...
        {!premium && (
          <div className="space-y-1 rounded-lg border border-amber-300 bg-amber-50 p-3 text-sm">
            ...
            <p className="text-amber-700">無料会員の募集は「自由参加（承認不要）」になります。</p>
