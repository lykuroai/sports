...
// 値は [south, west, north, east]。各県の本土主要部（離島は概ね除外）。
export const PREFECTURE_BBOX: Record<string, Bbox> = {
  ...
  "愛知県": [34.57, 136.66, 35.42, 137.84],
  "京都府": [34.70, 134.85, 35.78, 136.06],
  "兵庫県": [34.15, 134.25, 35.67, 135.47],
  "福岡県": [33.10, 130.00, 34.00, 131.00],
  "北海道": [42.80, 140.95, 43.30, 141.70], // 札幌都市圏に限定（全道は広大すぎ取得過多）
  "宮城県": [38.05, 140.55, 38.55, 141.20], // 仙台都市圏中心
  "広島県": [34.20, 132.30, 34.60, 132.80], // 広島都市圏中心
};
